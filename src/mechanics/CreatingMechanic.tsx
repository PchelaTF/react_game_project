...
export function createNewCharacter(
  ...
  switch (characterClass) {
    case WARRIOR_CLASS:
      ...
      return new Warrior({
        ...objSum(warriorStats, returnRaceMod(characterRace[activeRace])),
        initName: name,
        initImgBig: img,
        initImgSmall: icon,
        initSkillImgs: skillImgs,
      });
    case MAGE_CLASS:
      // return new Mage(10, 8, { min: 5, max: 15 }, name, false, 2)
      return new Mage({
        ...objSum(mageStats, returnRaceMod(characterRace[activeRace])),
        initName: name,
        initImgBig: img,
        initImgSmall: icon,
        initSkillImgs: skillImgs,
    ...
    case ROGUE_CLASS:
      ...
      return new Rogue({
        ...objSum(rogueStats, returnRaceMod(characterRace[activeRace])),
        initName: name,
        initImgBig: img,
        initImgSmall: icon,
        initSkillImgs: skillImgs,
