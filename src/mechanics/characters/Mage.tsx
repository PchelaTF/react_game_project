...
export class Mage extends Character {
  ...
  firstSkill(dmgToCharacter: Character) {
    ...
    dmgToCharacter.setHp(
      dmgToCharacter.getHp() - (Math.floor(Math.random() * (6 - 1 + 1) + 1) + this.calcMod(this.getInt()))
    );
  }
  ...
  secondSkill(dmgToCharacter: Character): void {
    ...
    dmgToCharacter.setHp(
      dmgToCharacter.getHp() - (Math.floor(Math.random() * (10 - 1 + 1) + 1) + this.calcMod(this.getInt()))
    );
  }
